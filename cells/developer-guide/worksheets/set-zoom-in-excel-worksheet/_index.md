---
title: "Set zoom in Excel Worksheet"
type: docs
url: /set-zoom-in-excel-worksheet/
weight: 220
---

## **Introduction**
This example shows how to set the zoom value of a Excel Worksheet using Aspose.Cells Cloud API in your applications. You can use our REST API with any language: .NET, Java, PHP, Ruby, Rails, Python, jQuery and many more.

## **API Information**

|**API**|**Type**|**Description**|**Resource Link**|
| :- | :- | :- | :- |
|` `/cells/{name}/worksheets/{sheetName}/zoom|` `POST|` `Set value of zoom in a Excel Worksheet|[PostWorksheetCellsRangeValue](https://apireference.aspose.cloud/cells/#/Worksheets/PostUpdateWorksheetZoom)|
### **cURL Example**
...
curl -X POST "https://api.aspose.cloud/v3.0/cells/test.xlsx/worksheets/Sheet1/zoom?value=40" -H "accept: application/json" -H "Content-Type: application/json" 

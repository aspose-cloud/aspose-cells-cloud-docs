...
## **Introduction**
This example shows how to protect a workbook using our REST API which can be used with any language: .NET, Java, PHP, Ruby, Rails, Python, jQuery and many more.
## **API Information**

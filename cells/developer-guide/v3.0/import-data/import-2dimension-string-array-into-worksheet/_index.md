...
|Parameter Name|Type|Description|
| :- | :- | :- |
|Import2DimensionIntegerArrayOption|Object | import 2 dimension integer array data option.The first part of the multipart content.|
...
curl -X POST "http://api.aspose.cloud/v3.0/cells/Book1.xlsx/importdata" -d '{"FirstRow":1,"FirstColumn":2,"IsVertical":true,"Data":null,"DestinationWorksheet":"Sheet1","IsInsert":true,"ImportDataType":"TwoDimensionIntegerArray","Source":{"FileSourceType":1,"FilePath":"Array_2integers_json.txt"}}' -H "Content-Type: application/json" -H "Accept: application/json"

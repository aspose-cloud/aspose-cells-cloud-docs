...
type: docs
url: /convert-list-object-or-table-to-range/
weight: 30
---

## **Convert List Object or Table to Range**
The following sample code illustrates how to convert List Object or Table to Range using Aspose.Cells Cloud API in your applications. You can use our REST API with any language: .NET, Java, PHP, Ruby, Rails, Python, jQuery and many more.
### **API Information**

|**API**|**Type**|**Description**|**Resource Link**|
| :- | :- | :- | :- |
|/cells/{name}/worksheets/{sheetName}/listobjects/{listObjectIndex}/ConvertToRange|POST|Converts list object to range in worksheet|[PostWorksheetListObjectConvertToRange](https://apireference.aspose.cloud/cells/#/ListObjects/PostWorksheetListObjectConvertToRange)|
### **cURL Example**
...
curl -X POST "https://api.aspose.cloud/v3.0/cells/Book1.xlsx/worksheets/Sheet1/listobjects/0/ConvertToRange" 
...

{
    ...
    url = @"http://api.aspose.com/v3.0/storage/file/Temp/V17.02.00\_04.xlsx";
    ...
    url = @"http://api.aspose.com/v3.0/cells/V17.02.00\_04.xlsx?folder=Temp";
    ...
    url = @"http://api.aspose.com/v3.0/cells/V17.02.00\_04.xlsx/worksheets/Sheet1?folder=Temp";
    ...
    url = @"http://api.aspose.com/v3.0/cells/V17.02.00\_04.xlsx/importdata?folder=Temp";
    ...
    url = "http://api.aspose.com/v3.0/cells/V17.02.00\_04.xlsx/worksheets/Sheet1/listobjects?startRow=0&startColumn=0&endRow=7&endColumn=4&hasHeaders=True&folder=Temp";
    ...
    url = "http://api.aspose.com/v3.0/cells/V17.02.00\_04.xlsx/worksheets/Sheet1/listobjects/0/ConvertToRange?folder=Temp";
